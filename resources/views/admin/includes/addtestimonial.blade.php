								...
								<div class="x_content">
									...
									<form action = "{{route('storetestimonial')}}" method= "post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="message" name="message" required="required" class="form-control">{{old('message')}}</textarea>
                                                @error('message')
                                                {{$message}}
                                                @enderror
											</div>
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" name= "published" @checked(old('published')) class="flat">
												</label>
											</div>
										</div>
										<div class="item form-group">
